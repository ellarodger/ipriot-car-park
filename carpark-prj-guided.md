...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
![img.png](images/attribute_and_assertion_error.png)
![img.png](images/no_errors_display.png)
...
Within the CarPark unit test because the method is called within the CarPark class
